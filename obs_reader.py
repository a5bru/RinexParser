...
from ext.convertdate.convertdate import year_doy
from logger import logger
from obs_header import Rinex2ObsHeader, Rinex3ObsHeader
from obs_epoch import RinexEpoch
...
class Rinex2ObsReader(object):
    ...
    def __init__(self, **kwargs):
        ...
        logger.debug(self.header.format_version)
    ...
    def read_header(self, sort_obs_types=True):
        ...
        # logger.info("Successfully read rinex header")
    ...
    def add_satellite(self, satellite):
        ...
        """
        if not self.header.satellites.has_key(satellite):
...
class Rinex3ObsReader(Rinex2ObsReader):
    ...
    def __init__(self, **kwargs):
        ...
        # logger.info(os.path.basename(self.rinex_obs_file))
    ...
    def read_data_to_dict(self):
        ...
        with open(self.rinex_obs_file, "r") as handler:
            ...
            # del i
            i = 0
            logger.debug("Search for epochs")
            rinex_obs = {
                "epochs": [], 
                "fileName": self.rinex_obs_file,
                "year4": self.year,

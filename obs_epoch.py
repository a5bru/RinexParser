...
import datetime
from constants import RNX_FORMAT_DATETIME, RINEX3_FORMAT_OBS_TIME,\
    RINEX3_SATELLITE_SYSTEMS
...
class RinexEpoch(object):
    ...
    def get_satellite_systems(self):
        ...
        """
        satellite_systems = []
        for satellite_system in RINEX3_SATELLITE_SYSTEMS:
            for satellite in self.satellites:
    ...
    def to_rinex3(self):
        ...
        data_lines += "> {epoch_time}  {epoch_flag}{nos:3d}{empty:6s}{rcvco}".format(
            epoch_time=self.timestamp.strftime(RINEX3_FORMAT_OBS_TIME),
